...
@section('content')
    ...
    <div class="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div class="flex items-center justify-between px-6 py-4">
          <!-- Search Form -->
          <form action="{{ route('majors-management.index') }}" class="w-96">
          ...
          <!-- Create Button -->
          <a href="{{ route('majors-management.create') }}"
                        ...
                        <tr>
                            ...
                            <td class="px-5 py-4 sm:px-6">
                                <div class="flex items-center gap-2">
                                    <a href="{{ route('majors-management.edit', $row->id) }}"
                                    ...
                                    <a href="{{route('majors-management.delete', $row->id)}}" 
                                        ...
                                        data-id="{{ $row->id }}"
                                        data-url="{{ route('majors-management.delete', $row->id) }}">
