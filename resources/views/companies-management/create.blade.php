...
@section('title', 'Create new companies-management')

@section('content')
    <!-- Breadcrumb Start -->
    <div x-data="{ pageName: `Companies Management` }">
    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <form action="{{ route('companies-management.store') }}" method="POST" enctype="multipart/form-data" class="w-full">
            @csrf
