...
<head>
    ...
    <title>LAPORAN PENGAJUAN PKL</title>
    <style>
        @page {
            size: A4;
            margin: 0;
...
<body>
    <div class="container">
        ...
        <div class="document-title">LAPORAN PENGAJUAN PKL</div>
        ...
        <div class="content">
            ...
            <table class="report-table">
                ...
                <tbody>
                    @foreach ($internship_request as $row)
                    <tr>
                        <td>{{$loop->iteration}}</td>
                        <td>{{$row->user->fullname}}</td>
                        <td>{{$row->company->name}}</td>
                        <td>{{round($row->user->student->avg_scores, 2)}}</td>
                        <td>{{round($row->weighing_scores, 3)}}</td>
                        <td>{{$row->status}}</td>
