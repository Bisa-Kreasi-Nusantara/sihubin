...
@section('title', 'Create new criteria-weight-management')
...
@section('content')
    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <form action="{{ route('criteria-weight-management.store') }}" method="POST" enctype="multipart/form-data" class="w-full">
            @csrf
                    ...
                    <div>
                        ...
                        <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                            <select
                                ...
                                <option value="benefit" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Benefit</option>
                                <option value="Cost" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Cost</option>
                            </select>
                            <span
