...
@section('content')
    ...
    <div class="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div class="w-full px-6 py-4 text-right">
                        ...
                        <tr>
                            ...
                            <td class="px-5 py-4 sm:px-6">
                                <div class="flex items-center gap-2">
                                    ...
                                    <a href="#"
                                        class="inline-flex items-center gap-2 px-2.5 py-1.5 text-xs font-medium text-white transition rounded-md bg-error-500 shadow hover:bg-error-600">
