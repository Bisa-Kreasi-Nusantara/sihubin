...
@section('title', 'Edit students-management')
...
@section('content')
    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <form action="{{ route('students-management.update', $user->id) }}" method="POST" enctype="multipart/form-data" class="w-full">
            @csrf
            @method('PUT')
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        min="0" 
                            ...
                            name="avg_scores"
                            value="{{round($user->student->avg_scores, 2)}}" />
                    </div>
                        ...
                        <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                            <select
                                ...
                                @foreach ($majors as $item)
                                    <option value="{{$item->id}}" {{ $item->id == $user->student->majors_id ? 'selected' : '' }} class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">{{$item->name}}</option>
                                @endforeach
                            </select>
                            <span
