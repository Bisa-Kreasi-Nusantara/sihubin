...
@section('content')
    ...
    <div class="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div class="flex items-center justify-between px-6 py-4">
          <!-- Search Form -->
          <form action="{{ route('role-permission.index') }}" class="w-96">
            ...
            <table class="min-w-full">
                ...
                <thead>
                    <tr class="border-b border-gray-100 dark:border-gray-800">
                        ...
                        <th class="px-5 py-3 sm:px-6">
                            <div class="flex items-center">
                                <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Role Name</p>
                            </div>
                        </th>
                        <th class="px-5 py-3 sm:px-6">
                            <div class="flex items-center">
                                <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Total Permission</p>
                            </div>
                        </th>
                        <th class="px-5 py-3 sm:px-6">
                            <div class="flex items-center">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                    @forelse ($roles as $row)
                        <tr>
                            ...
                            <td class="px-5 py-4 sm:px-6">
                                <div class="flex items-center">
                                    <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ $row->permissions->count() }} permission(s)</p>
                                </div>
                            </td>
                            <td class="px-5 py-4 sm:px-6">
                                <div class="flex items-center gap-2">
                                    <a href="{{ route('role-permission.edit', $row->id) }}"
                                    ...
                                    <a href="{{route('role-permission.delete', $row->id)}}" 
                                        ...
                                        data-id="{{ $row->id }}"
                                        data-url="{{ route('role-permission.delete', $row->id) }}">
